...
#define WSR_PERIOD_FILTER_MIN        (120/WSR_TIMER_PERIOD_US)   //min 300uS  allowed through filter
#define WSR_PERIOD_FILTER_MAX        (380/WSR_TIMER_PERIOD_US)  //max 1800uS allowed through filter
//detection of a 'SHORT', nominal 367uS
#define WSR_SHORT_PERIOD_MIN         WSR_PERIOD_FILTER_MIN       //
#define WSR_SHORT_PERIOD_MAX         (300/WSR_TIMER_PERIOD_US)   //max 600uS for a "SHORT"
//detection of a 'LONG', nominal 1464uS
#define WSR_LONG_PERIOD_MIN          (350/WSR_TIMER_PERIOD_US)  //min 1200uS for a "LONG"
